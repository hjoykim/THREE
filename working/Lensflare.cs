...
namespace THREE
{
    ...
    public class Lensflare : Mesh
    {
        ...
        public Lensflare() : base()
        {
            ...
            // textures
            ImageResult tempImage = new ImageResult();
            tempImage.Comp = ColorComponents.RedGreenBlueAlpha;
            tempImage.Data = new byte[16 * 16 * 4];
            tempImage.Width = 16;
            tempImage.Height = 16;
            tempMap = new DataTexture(tempImage, 16, 16, Constants.RGBAFormat, Constants.UnsignedByteType);          
            ...
            ImageResult occlusionImage = new ImageResult();
            occlusionImage.Comp = ColorComponents.RedGreenBlueAlpha;
            occlusionImage.Data = new byte[16 * 16 * 4];
            occlusionImage.Width = 16;
            occlusionImage.Height = 16;
            occlusionMap = new DataTexture(occlusionImage, 16, 16, Constants.RGBAFormat, Constants.UnsignedByteType);
