    ...
    public class Lut
    {
        ...
        */
        public Texture CreateTexture()
        {
            ...
            ImageResult image = new ImageResult();// new Bitmap(1, this.n.Value);
            image.Width = 1;
            image.Height = this.n.Value;
            image.Comp = ColorComponents.RedGreenBlueAlpha;
            image.Data = new byte[n.Value * 4];
            texture.Image = image;
        ...
        public void UpdateTexture(Texture texture)
        {
            ...
            Array.Copy(data,texture.Image.Data, data.Length);
        }
    }
