...
namespace THREE
{
    ...
    public class DataTexture : Texture
    {
        ...
        public DataTexture(ImageResult image, int width, int height, int format, int type, int? mapping = null, int? wrapS = null, int? wrapT = null, int? magFilter = null, int? minFilter = null, int? anisotropy = null, int? encoding = null)
