...
namespace THREE
{
    ...
    public class Texture : DisposableObject
    {
        ...
        /// Constructor
        /// </summary>
        public Texture(ImageResult image = null, int? mapping = null, int? wrapS = null, int? wrapT = null, int? magFilter = null, int? minFilter = null, int? format = null, int? type = null, int? anisotropy = null, int? encoding = null)
            : this()
        {
