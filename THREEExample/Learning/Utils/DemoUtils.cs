...
namespace THREEExample.Learning.Utils
{
    public class DemoUtils
    {
        ...
        private static void CreateBoundingWall(Scene scene)
        {
            ...
            var wallMaterial = new MeshPhongMaterial() { Color = new Color().SetHex(0xa0522d) };
        ...
        private static void CreateTree(Scene scene)
        {
            ...
            var trunkMesh = new Mesh(trunk, new MeshPhongMaterial() { Color = new Color().SetHex(0x8b4513) });

            var leavesMesh = new Mesh(leaves, new MeshPhongMaterial() { Color = new Color().SetHex(0x00ff00) });
