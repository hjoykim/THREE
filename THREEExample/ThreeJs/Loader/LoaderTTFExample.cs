...
namespace THREEExample.Three.Loaders
{
    ...
    public class LoaderTTFExample : Example
    {
        ...
        private void OnKeyPress(object sender, THREE.KeyPressEventArgs e)
        {
            int k = (int)e.Key[0];
            int b = (int)Keys.Backspace;
            if ((int)e.Key[0] == 8) //(int)Keys.Backspace)
            {
        ...
        private void OnMouseDown(object sender, THREE.MouseEventArgs e)
        {
        ...
        private void OnMouseUp(object sender, THREE.MouseEventArgs e)
        {
            MouseMove -= OnMouseMove;
            MouseUp -= OnMouseUp;
        }
