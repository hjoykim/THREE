...
namespace THREEExample.Three.Misc.Controls
{
    ...
    public class TransControlsExample : Example
    {
        Scene scene;
        ...
        TransformControls1 transformControls;
        ...
        public virtual void BuildScene()
        {
            ...
            transformControls = new TransformControls1(glControl,camera);
        ...
        private void OnPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            if(e.PropertyName.Equals("dragging"))
            {
                ...
                controls.Enabled = !(sender as TransformControls1).dragging;
    ...
    class TransformControls1 : Object3D, INotifyPropertyChanged
    {
        ...
        public TransformControls1(Control control,Camera camera) : base()
        {
    ...
    class TransformControlsGizmo : Object3D
    {
        ...
        #endregion
        TransformControls1 transformControls;
        public TransformControlsGizmo(TransformControls1 transformControls) : base()
        {
        ...
        private Object3D GetHelperTranslate()
        {
    ...
    class TransformControlsPlane : Mesh
    {
        ...
        public TransformControlsPlane(TransformControls1 controls) : base(new PlaneGeometry(100000, 100000, 2, 2),
