...
namespace THREE
{
    public class CinematicCamera : PerspectiveCamera
    {
        ...
        IControlsContainer glControl;
        public CinematicCamera(IControlsContainer glControl, float fov, float aspect, float near, float far) : base(fov, aspect, near, far)
        {
        ...
        public void InitProcessing()
        {
            if ((bool)this.postprocessing["enabled"])
            {
                ...
                this.postprocessing["camera"] = new OrthographicCamera(glControl.ClientRectangle.Width / -2, glControl.ClientRectangle.Width / 2, glControl.ClientRectangle.Height / 2, glControl.ClientRectangle.Height / -2, -10000, 10000);
                ...
                this.postprocessing["rtTextureDepth"] = new GLRenderTarget(glControl.ClientRectangle.Width, glControl.ClientRectangle.Height, pars);
                this.postprocessing["rtTextureColor"] = new GLRenderTarget(glControl.ClientRectangle.Width, glControl.ClientRectangle.Height, pars);
                ...
                (this.postprocessing["bokeh_uniforms"] as GLUniforms)["textureWidth"] = new GLUniform { { "value", glControl.ClientRectangle.Width } };

                (this.postprocessing["bokeh_uniforms"] as GLUniforms)["textureHeight"] = new GLUniform { { "value", glControl.ClientRectangle.Height } };
                ...
                this.postprocessing["quad"] = new Mesh(new PlaneBufferGeometry(glControl.ClientRectangle.Width, glControl.ClientRectangle.Height), this.postprocessing["materialBokeh"] as ShaderMaterial);
