...
namespace Typography.TextLayout
{
    ...
    public class GlyphLayout
    {
        ...
        public GlyphIndexList _inputGlyphs = new GlyphIndexList();//reusable input glyph
        public GlyphPosStream _glyphPositions = new GlyphPosStream();
    ...
    {
        public List<GlyphPos> _glyphPosList = new List<GlyphPos>();
